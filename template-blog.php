                ...
                <div class="blog-content">
                    ...
                    <?php else : ?>
                        <div class="no-posts-found py-5">
                            ...
                            <p>Check back soon for appliance troubleshooting guides, maintenance tips, and industry updates from Srinagar's repair experts.</p>
                        </div>
                    <?php 
                    endif; 
                    
                    // Reset query back to the static page query so sidebar widgets don't break
                    wp_reset_postdata();
                    $wp_query = $temp_query;
                    ?>
                </div>
